 ...
 * Later exposed as QUnit.configs
 * `configs` initialized at top of scope
 */
config = {
    ...
    // when enabled, the id is set to `true` as a `QUnit.configs` property
    urlConfig: [
        {
            id: "hidepassed",
...
// Initialize more QUnit.configs and QUnit.urlParams
(function() {
    var i, current,
...
// Updates the URL with the new state of `configs.urlConfig` values.
...
function toolbarUrlConfigContainer() {
    ...
    addClass( urlConfigContainer, "qunit-url-configs" );
