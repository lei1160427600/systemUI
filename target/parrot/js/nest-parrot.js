...
(function (window, $, moment, jsface) {
  ...
  */
   ...
   * @param config {{}} validate rules configs
...
(function (window, $, jsface, React) {
  ...
  * @param config {{}} special component configs, will replace the definition from component base if with same name
  */
